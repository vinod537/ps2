...
<div class="col-md-2">
	...
	<a class="navbar-brand align-self-center" href="{{ route('home') }}"><img style="position: relative;
...
font-size: 12px;">Share this</span>
    ...
    <div class="sg-page-content">
			...
			<!-- <div class="leftads">
				@foreach($ads_AdLocation as $key => $ads_AdLocations)
					@if($ads_AdLocations->unique_name == 'single_post_left')
			...
			<!-- <div class="rightads">
				@foreach($ads_AdLocation as $key => $ads_AdLocations)
					@if($ads_AdLocations->unique_name == 'single_post_right')
						@if($ads_AdLocations->ad->ad_type == 'image')
						<a href="{{$ads_AdLocations->ad->ad_url}}">
								<img src=" {{static_asset($ads_AdLocations->ad->adImage->original_image)}}" alt="" style="">	
							</a>
	...
	<!-- <div class="topads">
				...
				@foreach($ads_AdLocation as $key => $ads_AdLocations)
					@if($ads_AdLocations->unique_name == 'single_post_top')
						@if($ads_AdLocations->ad->ad_type == 'image')
							<a href="{{$ads_AdLocations->ad->ad_url}}">
								<img src=" {{static_asset($ads_AdLocations->ad->adImage->original_image)}}" alt="" style="">	
							</a>
                ...
                <div class="entry-thumbnail">
                    ...
                    <!-- @if($post->layout == 'style_3')
                        @include('site.pages.event.partials.detail_image')
                    @endif -->
                            ...
                            <div class="section-content gdg_-0-09">
                                ...
                                <div class="sg-post">
                                    ...
                                    @if($post->layout =='default')
                                        ...
                                        @include('site.pages.event.style_1')

                                    @elseif($post->layout == 'style_2')

                                        @include('site.pages.event.style_2')

                                    @elseif($post->layout == 'style_3')

                                        @include('site.pages.event.style_3')
...
<div class="popup__all__contents">
	...
	<div class="img__0912">
	<img src="{{url('/')}}/public/site/images/subscribe_now.png" />
	</div>
