<div class="entry-header">
	...
	<div class="entry-thumbnail" height="100%">
		...
		<img class="img-fluid" src="{{static_asset('default-image/Press-Release-768x411.png') }} " alt="{!! $post->title !!}">
	</div>
...
<div class="entry-content p-4 add__class__088">
	...
	@include('site.pages.event.partials.audio')
	@endif
	<div class="paragraph">
		{!! $post->content !!}
	</div>
	...
	@endif
	@include('site.pages.event.partials.content')
	...
	@include('site.pages.event.partials.trivia-quiz')
	@endif
	@if(@$post->post_type == 'personality-quiz')
	@include('site.pages.event.partials.personality-quiz')
	@endif
