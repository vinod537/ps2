...
<div class="loader">
 <img src="<?php echo e(static_asset('images/pharmashots_loader.gif')); ?>" />
            ...
            <div class="d-md-flex justify-content-md-between">
                <div class="left-contennt d-flex d-flex-style-3">
                    <div class="weather-content d-flex mr-5">
                        <div class="date">
                            <span><i class="fa fa-calendar mr-2" aria-hidden="true"></i><?php echo e(date('l, d F Y')); ?></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="header-bottom header_top" id="headdf">
        <div class="container">
            ...
            <div class="text-center new_text" style="text-align: center;">
                <a class="navbar-brand align-self-center" href="<?php echo e(route('home')); ?>">
                            ...
                            <?php $__currentLoopData = $primaryMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mainMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($mainMenu->is_mega_menu == 'no'): ?>
                                    <li class="nav-item sg-dropdown">
                                        <a href="<?php echo e(menuUrl($mainMenu)); ?>" target="<?php echo e($mainMenu->new_teb == 1? '_blank':''); ?>"><?php echo e($mainMenu->label == 'gallery'? __('gallery'):$mainMenu->label); ?> <?php if(!blank($mainMenu->children)): ?><span><i class="fa fa-angle-down" aria-hidden="true"></i></span><?php endif; ?> 
                                        <span class="pa-notification-badge">3</span>
                                        </a>
                                                ...
                                                <li class=""><a href="<?php echo e(menuUrl($child)); ?>" target="<?php echo e($child->new_teb == 1? '_blank':''); ?>"><?php echo e(@$child->label); ?> <?php if(!blank($child->children)): ?> <span class="pull-right"><i class="fa fa-angle-right" aria-hidden="true"></i></span><?php endif; ?></a>
                                                    <ul class="sg-dropdown-menu-menu">
                                                        <?php $__currentLoopData = $child->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subChild): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class=""><a href="<?php echo e(menuUrl($subChild)); ?>" target="<?php echo e($subChild->new_teb == 1? '_blank':''); ?>"><?php echo e(@$subChild->label); ?> <span class="pa-notification-badge">3</span></a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					   ...
					   <span class="search__click_09"><i class="fa fa-search"></i></span>
                        <div class="search-form d__rtt new_drtt search__popup">
                            ...
                            <form action="<?php echo e(route('article.search')); ?>" id="search" method="GET">
                                ...
                                <button type="submit" name="submit"><i class="fa fa-search"></i><span class="d-none"><?php echo e(__('search')); ?></span></button>
                            </form>
                        </div>
                    </div>
				</div>
...
<!--                                <a href="<?php echo e(route('site.login.form')); ?>"><?php echo e(__('')); ?></a> <span class="d-none-small"><a href="<?php echo e(route('site.login.form')); ?>"> <?php echo e(__('Subscribe Now')); ?></a></span>-->
                                        <span class="d-none-small"><a href="<?php echo e(url('/')); ?>/#newsletters"> <?php echo e(__('Subscribe Now')); ?></a></span>
                            </span>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php /**PATH H:\xampp\htdocs\Notion\ps2\resources\views/site/layouts/header/style_6.blade.php ENDPATH**/ ?>