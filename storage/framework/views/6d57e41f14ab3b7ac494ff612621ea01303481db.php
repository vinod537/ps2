...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route' => ['save-new-press-release','article'],'method' => 'post','enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="col-6 text-right">
                                <div class="form-group">
                                    ...
                                    <button type="submit" name="btnSubmit" class="btn btn-primary pull-right"><i
                                            class="m-r-10 mdi mdi-plus"></i><?php echo e(__('Publish Press Release')); ?></button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9">
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_title" class="col-form-label"><?php echo e(__('Press Release Title')); ?>*</label>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Post/Providers/../Resources/views/press_release_create.blade.php ENDPATH**/ ?>