            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about__img_08">
                        ...
                        <!--	   <img src="<?php echo e(static_asset('site/images/about__img.png')); ?> "  >-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="goal">
                        <div class="row">
                            <div class="col-md-6"><img src="<?php echo e(static_asset('site/images/imgg.png')); ?> "></div>
                            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="history">
                        <div class="row">
                            <div class="col-md-6"><img src="<?php echo e(static_asset('site/images/imgg2.png')); ?> "></div>
                            <div class="col-md-6">
                    ...
                    <ul>
                        ...
                        <li class="para_list new__paralist"><span class="in__0">Connect with us to know more about
                                our premium bespoke service. </span> <span class="para_button"><a
                                    href="<?php echo e(url('/')); ?>/be-spoke">Contact us</a></span> </li>
                    ...
                    <div id="collapseThree3" class="collapse" role="tabpanel" aria-labelledby="headingThree3"
                        ...
                        <div class="card-body">
                            ...
                            with summarization of regulatory policies. Learn more about it <strong><a
                                    href="<?php echo e(url('/')); ?>/be-spoke">here</a></strong>.
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFour4" class="collapse" role="tabpanel" aria-labelledby="headingFour4"
                        ...
                        <div class="card-body">
                            ...
                            <p>Click <strong><a href="<?php echo e(url('/')); ?>/be-spoke">here</a></strong> to show interest and
                                find our pricing.</p>
                        </div>
                    ...
                    <div id="collapseFive5" class="collapse" role="tabpanel" aria-labelledby="headingFive5"
                        ...
                        <div class="card-body">
                            ...
                            PharmaShots readers. Find more details <strong><a
                                    href="<?php echo e(url('/')); ?>/news-wire">here</a></strong>.
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row dsk__top_23">
                ...
                ?>
                    ...
                    <?php $__currentLoopData = $aboutUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$aboutUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-22">
                    ...
                    <div class="box4">
                        <div class="sicons__09"> <img src="<?php echo e(static_asset($aboutUser->profile_image)); ?> ">
                    ...
                    <div class="khe__team">
                        <h3><?php echo e($aboutUser->first_name); ?> <?php echo e($aboutUser->last_name); ?></h3>                        
                        <p><?php echo e($aboutUser->position); ?></p>
                        <ul class="social_meda">


                            <li> <a href="<?php echo e($aboutUser->social_media); ?>"><i
            ...
            <div class="box4">
             <div class="sicons__09"> <img src="<?php echo e(static_asset('site/images/4.png')); ?> ">
...
<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/site/pages/default_page.blade.php ENDPATH**/ ?>