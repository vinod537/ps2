      ...
      <div class="row">
         ...
         <div class="col-md-<?php echo e($class); ?>">
            <div class="video_sections__pro">
                <iframe width="100%" height="500" data-src="<?php echo e($youtubevideo->embed_video); ?>?controls=0"></iframe>
            </div>  
         </div>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>      	
...
<?php /**PATH C:\xampp\htdocs\pharmashots\resources\views/site/partials/home/primary/style_3.blade.php ENDPATH**/ ?>