    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <input class="gallery_Search form-control" placeholder="Search Image" id="gallery_Search" type="text"  name="">
...
<script>
    ...
    $(document).ready(function (e) {
        ...
        urlsearch = "<?php echo e(route('fetch-image-search')); ?>";
        ...
        $(document).on('keyup', '#gallery_Search', function () {
            var image_page_no = 1;
            var keyword = $(this).val();          
            let next_url = urlsearch;
                if(keyword !='' && keyword !='undefined'){
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            // }
                            $('#ajax-image-loading').hide();
                            $('#load-more-image').html('<button class="btn btn-primary">Move to load more</button>');
                            $("#media-library").html(data);
                            // $("#imageCount").val(parseInt($("#imageCount").val()) + 1);
                        }
                    })
        ...
        $(document).on('click', '#load-more-image', function () {
            $('#load-more-image').text('Load more...');
...
<?php /**PATH /var/www/html/Modules/Gallery/Providers/../Resources/views/image-gallery.blade.php ENDPATH**/ ?>