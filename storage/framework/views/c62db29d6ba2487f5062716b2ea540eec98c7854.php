...
We know that you have a lot to do in a limited time and you can’t go through every news of your interest. We have summarized the news in three shots so that, you can keep yourself informed and focus on your business activities. Pharmashots app is designed for busy life sciences professional who wants news on the go.
           ...
           <div class="mainclasssliderimg">
                                            <ul>
											<li><a href="https://play.google.com/store/apps/details?id=com.pharmashotsapp"> <img src="<?php echo e(static_asset('site/images/')); ?>/gp.png"></a></li>
        ...
        <div class="col-md-6">
        <div class="jhjwe">
            <img src="<?php echo e(static_asset('site/images/Psappimage.png')); ?> "  >
...
<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/site/pages/pharma_apps.blade.php ENDPATH**/ ?>