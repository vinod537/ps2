...
class ColumnUpdate extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('settings')->insert([
            'title' => 'facebook_client_secretkey',
            'value' => '******************',
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'facebook_visibility',
            'value' => 0,
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'facebook_callback_url',
            'value' => 'https://example.net/login/facebook/callback',
            'lang' => 'en',
        ]);
        ...
        DB::table('settings')->insert([
            'title' => 'google_client_secretkey',
            'value' => '***********************',
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'google_visibility',
            'value' => 0,
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'google_callback_url',
            'value' => 'https://example.net/login/google/callback',
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'preloader_option',
            'value' => 1,
            'lang' => 'en',
        ]);

        DB::table('settings')->insert([
            'title' => 'submit_news_status',
            'value' => 1,
            'lang' => 'en',
        ]);
