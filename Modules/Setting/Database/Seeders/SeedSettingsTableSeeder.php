...
class SeedSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['title' => 'mail_host', 'value' => 'smtp.gmail.com', 'lang' => 'en']);
        Setting::create(['title' => 'sendmail_path', 'value' => '/usr/bin/sendmail -bs', 'lang' => 'en']);
        Setting::create(['title' => 'mail_port', 'value' => '465', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'aws_default_region', 'value' => 'ap-south-1']);
        Setting::create(['title' => 'aws_bucket', 'value' => 'demo11223']);
        ...
        Setting::create(['title' => 'notification_status', 'value' => '1', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'adthis_option', 'value' => '1', 'lang' => 'en']);
        Setting::create(['title' => 'inbuild_comment', 'value' => '1', 'lang' => 'en']);
        Setting::create(['title' => 'disqus_comment', 'value' => '0', 'lang' => 'en']);
        Setting::create(['title' => 'disqus_short_name', 'value' => 'onno', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'application_name', 'value' => 'ONNO', 'lang' => 'ar']);

        Setting::create(['title' => 'address', 'value' => 'khilkhet', 'lang' => 'ar']);
        Setting::create(['title' => 'phone', 'value' => '01400620055', 'lang' => 'ar']);

        Setting::create(['title' => 'zip_code', 'value' => '1207', 'lang' => 'ar']);
        Setting::create(['title' => 'city', 'value' => 'Dhaka', 'lang' => 'ar']);
        Setting::create(['title' => 'state', 'value' => 'Dhaka', 'lang' => 'ar']);
        Setting::create(['title' => 'country', 'value' => 'Country', 'lang' => 'ar']);
        Setting::create(['title' => 'website', 'value' => 'spaGreen.net', 'lang' => 'ar']);
        Setting::create(['title' => 'company_registration', 'value' => '123456789', 'lang' => 'ar']);
        Setting::create(['title' => 'tax_number', 'value' => '123456789', 'lang' => 'en']);
        Setting::create(['title' => 'about_us_description', 'value' => htmlspecialchars($faker->realText(2000)), 'lang' => 'ar']);

        Setting::create(['title' => 'copyright_text', 'value' => 'حقوق النشر  © 2020 ONNO News and Magazine - كل الحقوق محفوظة.', 'lang' => 'ar']);
        Setting::create(['title' => 'signature', 'value' => 'Best Regards', 'lang' => 'ar']);

        Setting::create(['title' => 'onesignal_action_message', 'value' => 'We\'d like to show you notifications for the latest updates.', 'lang' => 'ar']);
        Setting::create(['title' => 'onesignal_accept_button', 'value' => 'ALLOW', 'lang' => 'ar']);
        Setting::create(['title' => 'onesignal_cancel_button', 'value' => 'NO THANKS', 'lang' => 'ar']);

        //seo setting
        Setting::create(['title' => 'seo_title', 'value' => 'Your Website Title', 'lang' => 'ar']);
        Setting::create(['title' => 'seo_keywords', 'value' => '', 'lang' => 'ar']);
        Setting::create(['title' => 'seo_meta_description', 'value' => '', 'lang' => 'ar']);
        Setting::create(['title' => 'author_name', 'value' => 'SpaGreen', 'lang' => 'ar']);
        Setting::create(['title' => 'og_title', 'value' => 'Your Website Title', 'lang' => 'ar']);
        Setting::create(['title' => 'og_description', 'value' => '', 'lang' => 'ar']);
