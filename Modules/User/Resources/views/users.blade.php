                                        ...
                                        ?></td>
                                                <td>
                                                    @if(profile_exist($user->profile_image) && $user->profile_image!=null)
                                                        <img src=" {{static_asset($user->profile_image)}} "
                                                ...
                                                <td>{{ $user->first_name}} {{$user->last_name}}
                                                    ...
                                                    @if($user->social_media)
                                                        <a target="_blank" href="{{ $user->social_media}}"><i class="fa fa-linkedin" aria-hidden="true" style="
                                                            background: #00a0dc;
                                                            color: #fff;
                                                            padding: 6px;
                                                        "></i>
                                                ...
                                                <td>
                                                    @if($user->status_about)
                                                    <label class="label label-success">{{$user->status_about}}</label>
                                                    <label class="label btn-warning">{{$user->order_about}}</label>
                                                    @endif
