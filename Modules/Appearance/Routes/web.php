        ...
        Route::group(['middleware' => ['loginCheck']], function () {
            ...
            Route::group(['middleware' => ['XSS']], function () {
                ...
                route::post('update-section-order', 'ThemeSectionController@updateSectionOrder')->name('update-section-order')->middleware('permissionCheck:theme_section_write');
                 ...
                 route::get('youtubes', 'ThemeController@youtubes')->name('youtubes')->middleware('permissionCheck:theme_section_read');

                 Route::get('/create/youtube', 'ThemeController@createyoutube')->name('create-youtube')->middleware('permissionCheck:theme_section_read');
                 Route::post('/store/youtube', 'ThemeController@storeyoutube')->name('store-youtube')->middleware('permissionCheck:theme_section_read');
                 Route::get('/edit/{id}', 'ThemeController@edityoutube')->name('edit-youtube')->middleware('permissionCheck:theme_section_read');
                 Route::post('/update/{id}', 'ThemeController@updateyoutube')->name('update-youtube')->middleware('permissionCheck:theme_section_read');
                
                 Route::post('/get/video/detail', 'ThemeController@ajax_get_video_details')->name('admin.ajax_get_video_details');
                 Route::post('/video/change/status', 'ThemeController@youtube_change_status')->name('admin.youtube_change_status');


                //  route::get('sliders', 'ThemeController@sliders')->name('sliders')->middleware('permissionCheck:theme_section_read');

                //  Route::get('/create', 'ThemeController@createslider')->name('create-slider')->middleware('permissionCheck:ads_write');
                //  Route::post('/store', 'ThemeController@store')->name('store-slider')->middleware('permissionCheck:ads_write');
                //  Route::get('/edit/{id}', 'ThemeController@edit')->name('edit-slider')->middleware('permissionCheck:ads_write');
                //  Route::post('/update/{id}', 'ThemeController@update')->name('update-slider')->middleware('permissionCheck:ads_write');
