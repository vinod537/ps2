...
class GalleryController extends Controller
{
    ...
    public function imageUpload(Request $request){
        if ($request->file('image')) :
            ...
            $SamenameImageUrl          = $directory . $SamenameImageName;
            ...
            elseif(settingHelper('default_storage') =='local'):
                ...
                if ($fileType == 'jpeg' or $fileType == 'jpg' or $fileType == 'JPEG' or $fileType == 'JPG'):
                    ...
                    Image::make($requestImage)->save($SamenameImageUrl);
                    ...
                    Image::make(imagecreatefromjpeg($requestImage))->fit(730, 400)->save($bigImageUrlTwo, 100);
                    Image::make(imagecreatefromjpeg($requestImage))->fit(358, 215)->save($mediumImageUrl, 80);
                    Image::make(imagecreatefromjpeg($requestImage))->fit(350, 190)->save($mediumImageUrlTwo, 100);
                    Image::make(imagecreatefromjpeg($requestImage))->fit(255, 175)->save($mediumImageUrlThree, 100);
                ...
                elseif ($fileType == 'PNG' or $fileType == 'png'):
                    ...
                    Image::make(imagecreatefrompng($requestImage))->fit(730, 400)->save($bigImageUrlTwo, 100);
            ...
            $image->same_image            = str_replace("public/","",$SamenameImageUrl);
...
//                    Storage::disk('s3')->put($originalAudioUrl, $requestAudio);
    ...
    public function fetchImageSearch(Request $request)
    {
        ...
        $images  = galleryImage::orderBy('id','DESC')->where('same_image', 'like', '%' . $request->keyword . '%')->paginate(24);
