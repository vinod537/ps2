...
@section('post')
    active
@endsection
@section('advertisement-post-active')
    active
@endsection
...
@section('content')
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!!  Form::open(['route'=>'update-advertisement-order','method' => 'post','enctype'=>'multipart/form-data']) !!}
                                ...
                                <table class="table table-bordered table-striped" role="grid">
                                    ...
                                    @foreach ($posts as $post)
                                        <tr id="row_{{ $post->id }}">
                                            ...
                                            <td>
                                                <label class="category-label m-r-5 label-table" id="advertisement-post-bgc">
                                            ...
                                            <td width="10%">
                                                <input type="number" class="form-control btn btn-light" name="order[]"
                                                       value="{{ $post->advertisement_order }}">
                                            ...
                                            @if(Sentinel::getUser()->hasAccess(['post_write']))
                                                <td>
                                                    <a href="javascript:void(0)"
                                                       onclick="remove_post_form('other','advertisement','{{ $post->id }}')"
