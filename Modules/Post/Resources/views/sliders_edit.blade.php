...
<textarea name="content" value="{{ $slider->content }}" id="post_content"
                ...
                {!! $slider->content !!}
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="order_type" required name="order_type"  value="{{ $slider->order_type }}" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select id="show_hide" name="show_hide" type="number" class="form-control">
                                    <option @if($slider->show_hide == '1') selected @endif value="1">Show</option>
                                    <option @if($slider->show_hide == '0') selected @endif  value="0">Hide</option>
                                </select>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select id="button_type" name="button_type" class="form-control">
                                    <option @if($slider->button_type == 'ContactUrl') selected @endif  value="ContactUrl">Contact Url</option>
                                    <option @if($slider->button_type == 'Newsletter') selected @endif  value="Newsletter">Newsletter</option>
                                    <option @if($slider->button_type == 'MobileApps') selected @endif  value="MobileApps">Mobile Apps</option>
                                </select>
                            </div>
                        </div> --}}
...
<script>
    var getvar = "<?php echo $slider->button_type; ?>";
    //alert(getvar);
    if (getvar == 'ContactUrl') {
        $('.urls').show();
    }else{
                $('.urls').hide(); 
            }
