                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="item-table-filter  col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input name="from_date" class="form-control" placeholder="{{__('search')}}"
                                                   type="date">                                                
                                            </div>
                                        </div>
                                        ...
                                        <div class="item-table-filter  col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input name="to_date" class="form-control" placeholder="{{__('search')}}"
                                                   type="date">                                              
                                            </div>
                                        </div>
                                    ...
                                    @foreach ($posts as $post)
                                        <tr id="row_{{ $post->id }}">
                                            ...
                                            <td>
                                                ...
                                                <a href="@if($post->old_id) {{ route('article.detail', [$post->old_id, $post->slug]) }} @else {{ route('article.detail', [$post->id, $post->slug]) }} @endif">{{ $post->title }} </a>
                                            </td>
                                            <!-- <td>{{ $post->language }} </td> -->
