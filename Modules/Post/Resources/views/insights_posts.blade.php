...
@section('content')
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!!  Form::open(['route'=>'update-insights-order','method' => 'post','enctype'=>'multipart/form-data']) !!}
                                ...
                                <table class="table table-bordered table-striped" role="grid">
                                    ...
                                    @foreach ($posts as $post)
                                        <tr id="row_{{ $post->id }}">
                                            ...
                                            <td>
                                                <label class="category-label m-r-5 label-table" id="insights-post-bgc">
                                            ...
                                            @if(Sentinel::getUser()->hasAccess(['post_write']))
                                                <td>
                                                    <a href="javascript:void(0)"
                                                       onclick="remove_post_form('other','insights_plus','{{ $post->id }}')"
