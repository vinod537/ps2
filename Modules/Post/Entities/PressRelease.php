...
class PressRelease extends Model implements Feedable
{
    protected $fillable = ['title','old_id','updated_at','created_at','content','meta_title','status','visibility','post_type','category_id','user_id','slug2','slug'];
