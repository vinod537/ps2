...
class UserController extends Controller
{
    ...
    public function socialloginredirect()
    {
        return redirect()->route('home')->with('success', __('Successfully Password Changed'));
        dd($_REQUEST);
    }
    ...
    public function PostResetPassword(Request $request, $email, $resetCode)
    {
        Validator::make($request->all(), [
            'password'              => 'confirmed|required|min:1|max:500',
            'password_confirmation' => 'required|min:1|max:500'
        ])->validate();
